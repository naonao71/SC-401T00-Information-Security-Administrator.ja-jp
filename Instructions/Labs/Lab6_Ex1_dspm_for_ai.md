...
1. ポップアップで、このポリシーで構成される内容の概要を確認します。
   ...
   - 既定のポリシー名は、**DSPM for AI - Unethical behavior in AI apps**です。
...
1. **[推奨事項]** ページが更新され、**[DSPM for AI - Unethical behavior in AI apps]** 推奨事項は **[完了]** に移動します。

1. 左側のナビゲーションで、 **[ポリシー]** を選択します。

1. 新しく作成した **DSPM for AI - Unethical behavior in AI apps**ポリシーを選択して、その構成と状態を確認します。

1. **[DSPM for AI - Unethical behavior in AI apps]** ページで、**[X]** を選択してポップアップを閉じます。
...
1. **[データ リスク アセスメント]** ページで、**[カスタム評価の作成 ]** を選択します。
