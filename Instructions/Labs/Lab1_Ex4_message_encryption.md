...
1. **[ルール条件の設定]** ページで、以下のように構成します。
   ...
   - **[次を実行します]** セクション:
     ...
     - **[次を実行します]** セクションの **[1 つ選択する]** リンクを選択します。
...
1. 別のアクションを追加するには、**[次を実行します]** セクションの右側にある**+** を選択します。
...
1. 新しく作成された **[And]** セクション:
   ...
   - ドロップダウンで **[テキストの入力]** を選択し、**[免責事項の指定す]** ポップアップに「`This email has been encrypted and sent securely by Contoso Ltd.`」と入力します。
