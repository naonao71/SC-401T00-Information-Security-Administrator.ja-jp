...
1. **[機密情報が含まれているコンテンツを定義する]** ページで、コンテンツに含まれているセクションで**[追加]** を選択します。
...
1. **[作成するアイテム保持ポリシーの種類を選択]** ページで、 **[アダプティブ]** を選択し、 **[次へ]** を選択します。

1. **[アダプティブ ポリシーのスコープと場所の選択]** ページで、 **[+ スコープを追加]** を選択します。

1. **[アダプティブ ポリシー スコープを選択]** ポップアップ パネルで、**[Leadership and Ops Groups]** のチェックボックスをオンにして、パネルの下部にある **[追加]** を選択します。

1. **[ポリシーを適用する場所の選択]** に戻り、次を有効にします。

    - Microsoft 365 グループメールボックスとMicrosoft 365 グループサイト
    - 他のすべての場所は無効のままにします。
